...
import { useBoards } from "@/lib/context/useBoards";
import { Board } from "@/lib/supabase/module";
...
export default function DashboardPage() {
    ...
    const baordsWithTaskCount = boards.map((board: Board) => ({
        ...board,
        taskCount: 0,
    }))

    const filteredBoards = baordsWithTaskCount.filter((board: Board) => {
    ...
    if (error) {
        return (
            <div>
                <h2 className=""> Error loading boards</h2>
                <p>{error}</p>
            </div>
        )
    }
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <main className="container mx-auto px-4 py-6 sm:py-8">
                ...
                {/* Stats Section */}
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb sm:mb-8">
                    <Card>
                ...
                <div className="mb-6 sm:mb-8">
                    ...
                    {boards.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                            ...
                            <Card className="border-2 border-dashed border-grey-300 hover:border-blue-400 transition-colors cursor-pointer group">
                        ...
                        <div>
                            ...
                            <Card className="mt-4 border-2 border-dashed border-grey-300 hover:border-blue-400 transition-colors cursor-pointer group">
                                <CardContent className="p-4 sm:p-6 flex flex-col items-center justify-center h-full min-h-50">
                                    <Plus className="h-6 w-6 sm:h-8 sm:w-8 text-gray-400 group-hover:text-blue-600 mb-2"/>
                                    <p className="text-sm sm:text-base text-gray-600 group-hover:text-blue-600 font-medium">Create new board</p>
                                </CardContent>
                ...
                <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <Input  type="date" 
                                        onChange={(e) => setFilters((prev) => ({...prev, dateRange: {...prev.dateRange,
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                <div>
                                    ...
                                    <Input  type="number"  min={0} placeholder="Min tasks"
                                        onChange={(e) => setFilters((prev) => ({...prev, taskCount: {...prev.taskCount,
                        ...
                        <div className="flex flex-col sm:flex-row justify-between pt-4 space-y-2 sm:space-y-0 sm:space-x-2">
                            ...
                            <Button onClick={() => setIsFilterOpen}>Apply Filters</Button>
                        </div>
                    </div>
                </DialogContent>
            </Dialog>
