...
import { useBoard } from "@/lib/context/useBoards";
import { ColumnWithTasks, Task } from "@/lib/supabase/module";
                ...
                <div className="p-2">{children} 
                    <Dialog>
                        <DialogTrigger asChild>
                            <Button className="w-full mt-3 text-gray-500 hover:text-gray-700 sm:w-auto" variant={"ghost"}>
                                <Plus />
                                Add Task
                            </Button>
                        </DialogTrigger>
            ...
            <Dialog open={isEditingColumn} onOpenChange={setIsEditingColumn}>
                <DialogContent className="w-[95vw] max-w-[425px] mx-auto">
                    ...
                    <form className="space-y-4" onSubmit={handleUpdateColumn}>
                        <div className="space-y-2">
                            <Label>Column Title</Label>
                            <Input id="columnTitle" value={editingColumnTitle} onChange={(e) => setEditingColumnTitle(e.target.value)}
                                placeholder="Enter column title..."
                                required
                            />
                        </div>
...
// reduce -> memungkinkan kita ngerun sum & colection -> jumlah kolom